export const term = {
  ...
  content: {
    ...
    concept: {
      ...
      en: "Think of sharding like a city library whose books have become too numerous for one building. The solution isn't building an ever-bigger building (scaling up), but opening several branch libraries across different areas of the city, where books are divided by a certain rule — e.g. branch A holds titles A-M, branch B holds N-Z. When you know the title you're looking for, you immediately know which branch to go to (routing based on the shard key), without needing to check every branch.",
    },
    methodology: {
